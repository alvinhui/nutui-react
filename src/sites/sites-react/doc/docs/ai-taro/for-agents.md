...
本页提供一段开箱即用的提示词，让任何 AI 编程 Agent 高效使用 NutUI-React（Taro 多端）。

## 复制这段提示词

把下面这段话复制到你的 Agent 对话或自动化流程中，让它在写 NutUI-React（Taro）代码前先建立正确的上下文：
...
[@dongweb/nutui-react-taro-cli](https://www.npmjs.com/package/@dongweb/nutui-react-taro-cli) 把组件的 Props、文档、Taro 示例与 Design Token 打包随包分发，安装后本地毫秒级查询，无需网络、无需 API Key。
...
| 文件 | 说明 |
| --- | --- |
| [llms.txt](https://nutui.jd.com/taro/react/4x/llms.txt) | 文档导航索引 |
| [llms-full-cn.txt](https://nutui.jd.com/taro/react/4x/llms-full-cn.txt) | 全部组件文档（中文） |

> 小程序端暂无英文全量文档。如需英文文档，请参考 [H5 端](https://nutui.jd.com/h5/react/4x/llms.txt)。

也可以获取单个组件文档：`https://nutui.jd.com/taro/react/4x/components/button.md`。
